...
public enum UUIDType {
	...
	public static UUIDType getInstance(String val) throws UUIDException
	{
		try {
		...
		for (UUIDType type: UUIDType.values()) {
			if (val == null ? type.code == null : val.equals(type.code)) {
				return type;
			}
		}

		throw new UUIDException("Invalid resource type. Valid types are: " +
				UUIDType.values());
	}
}
