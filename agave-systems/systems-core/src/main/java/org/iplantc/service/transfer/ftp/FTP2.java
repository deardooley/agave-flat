 ...
 * FTP servers, specifically Windows_NT and non MLSD varieties.
 * @author dooley
 *
 */
...
//	protected RemoteSystem system;
	...
	public FTP2(String host, int port, String username, String password, String rootDir, String homeDir)
	{
		super(host, port, username, password, rootDir, homeDir);
	}
...
//		setLocalActive();
	...
	throws IOException, RemoteDataException
	{
		...
		try 
		{
			ftp = new FTP2(this.host, this.port, this.username, this.password, this.rootDir, this.homeDir.substring(this.rootDir.length()));
	...
	private void copy(String remotesrc, String remotedest, FTP2 remoteDestClient, RemoteTransferListener listener) 
	throws IOException, RemoteDataException
	{
