...
public class AgaveJargonProperties implements JargonProperties {
	...
	private boolean usingSpecQueryForDataObjPermissionsForUserInGroup = true;
	...
	private boolean primaryTcpKeepAlive = true;
	private int primaryTcpSendWindowSize = 0;
	private int primaryTcpReceiveWindowSize = 0;
	private int primaryTcpPerformancePrefsConnectionTime = 0;
	private int primaryTcpPerformancePrefsLatency = 1;
	private int primaryTcpPerformancePrefsBandwidth = 2;
	private int socketRenewalIntervalInSeconds = 120;
	private boolean longTransferRestart = false;
	private boolean bypassSslCertChecks = true;
