 ...
 *
 */
@Test(singleThreaded=true, groups= {"sftp", "sftp-password", "filesystem", "broken", "integration"})
public class SftpPasswordRemoteDataClientTest extends AbstractRemoteDataClientTest {
