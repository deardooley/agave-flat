...
public class SystemSearchWithFieldFilterTest  extends SystemsModelTestCommon {
...
//	}
	...
	public void findMatching(String attribute, Object value) throws Exception
	{
		...
		List<RemoteSystem> systems = systemDao.findMatching(system.getOwner(), new SystemSearchFilter().filterCriteria(map), Settings.DEFAULT_PAGE_SIZE, 0, true);
    ...
    public void findMatchingTime(String attribute, Object value) throws Exception
    {
        ...
        systems = systemDao.findMatching(system.getOwner(), new SystemSearchFilter().filterCriteria(map), Settings.DEFAULT_PAGE_SIZE, 0, true);
