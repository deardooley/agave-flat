...
public class AgaveLogServiceClient {
	...
	public static enum ActivityKeys 
	{
		...
		JobsDelete, JobsGetByID, JobsGetOutput, JobsKill, JobsList, JobsListInputs, JobsResubmit, JobsListOutputs, JobsShare, JobsSubmit, JobsGetInput, JobsUsage, JobStatus, JobSearch, JobAttributeList, JobsGetHistory, JobSubmissionForm, JobsCustomRuntimeEvent, JobReset, 
