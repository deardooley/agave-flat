	...
	public String toJSONString()
	{
		...
		try
		{
			js.object().
				...
				.key("username").value(this.username != null ? this.username : "")
				.key("firstName").value(this.firstName != null ? this.firstName : "")
				.key("middleName").value(this.middleName != null ? this.middleName : "")
				.key("lastName").value(this.lastName != null ? this.lastName : "")
				.key("email").value(this.email != null ? this.email : "")
				.key("address").value(this.address != null ? this.address : "")
				.key("homePhoneNumber").value(this.homePhoneNumber != null ? this.homePhoneNumber : "")
				.key("homePhoneExtension").value(this.homePhoneExtension != null ? this.homePhoneExtension : "")
				.key("busPhoneNumber").value(this.busPhoneNumber != null ? this.busPhoneNumber : "")
				.key("busPhoneExtension").value(this.busPhoneExtension != null ? this.busPhoneExtension : "")
				.key("faxNumber").value(this.faxNumber != null ? this.faxNumber : "")
				.key("organization").value(this.organization != null ? this.organization : "")
				.key("department").value(this.department != null ? this.department : "")
				.key("position").value(this.position != null ? this.position : "")
				.endObject();
