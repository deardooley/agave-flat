...
//    	return mapper.getNodeFactory().POJONode(obj);
    ...
    protected Object[][] dataTestSoftwareFieldsInvalid = {
            ...
            {"version","1.a","set version to alphanumeric value",true},
            {"version","1.0.0a","set version to alphanumeric value",true},
            {"version","1.0.0-asdfas","set version to alphanumeric value with dash hash",true},
