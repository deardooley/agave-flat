...
//        } 
//		notificationDao.persist(system);
...
//		}
//		
//		List<Notification> systems = notificationDao.findMatching(system.getOwner(), new SystemSearchFilter().filterCriteria(map));
...
//		Assert.assertEquals(systems.get(0).getUuid(), notification.getUuid(), "findMatching did not return the saved system.");
//	}
//	
...
//        Assert.assertEquals(systems.get(0).getUuid(), notification.getUuid(), "findMatching did not return the saved system when searching by starttime.");
//        
//        map.clear();
//        map.put("created", formatter.format(system.getCreated()));
//        
//        systems = notificationDao.findMatching(system.getOwner(), new SystemSearchFilter().filterCriteria(map));
...
//        Assert.assertEquals(systems.get(0).getUuid(), notification.getUuid(), "findMatching did not return the saved system when searching by created.");
//    }
//	
...
//	{
//		Notification system = createEmailNotification();
//		if (StringUtils.equalsIgnoreCase(attribute, "privateonly")) {
//            system.setPubliclyAvailable(false);
//        } else if (StringUtils.equalsIgnoreCase(attribute, "publiconly")) {
//            system.setPubliclyAvailable(true);
