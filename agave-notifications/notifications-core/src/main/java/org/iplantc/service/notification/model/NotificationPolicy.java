...
public class NotificationPolicy
{
	...
	@Min(0)
	@Max(1440)
	private int retryLimit = Settings.MAX_NOTIFICATION_RETRIES;
	...
	/**
	 * Whether a failed {@link NotificationAttempt}s will be stored 
	 * if delivery cannot be made before this {@link NotificationPolicy} expires.
	 */
