 ...
 *
 */
public class RetryNotificationAttemptSchedulingPlugin extends GenericSchedulingPlugin
{
	private static final Logger log = Logger.getLogger(RetryNotificationAttemptSchedulingPlugin.class);
	/**
	 * 
	 */
	public RetryNotificationAttemptSchedulingPlugin() {
		super();
	}
	...
	{
		return RetryNotificationQueueProcessor.class;
	}

	@Override
	protected String getPluginGroup()
	{
		return "RetryNotificationAttempt";
	}
