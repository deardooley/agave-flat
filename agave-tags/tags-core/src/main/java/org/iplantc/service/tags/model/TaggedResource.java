...
public class TaggedResource {
    ...
    public JsonNode getLinks() { 
        ...
        try {
	        ...
	        linksObject.set("self", (ObjectNode)mapper.createObjectNode()
	            .put("href", TenancyHelper.resolveURLToCurrentTenant(Settings.IPLANT_TAGS_SERVICE) 
	            		+ getTag().getName()  + "/associations/" + getUuid())
	            .put("title", uuid.getResourceType().name().toLowerCase())
	            .put("rel", TenancyHelper.resolveURLToCurrentTenant(uuid.getObjectReference()))
	            );
        ...
        linksObject.set("tag", (ObjectNode)mapper.createObjectNode()
