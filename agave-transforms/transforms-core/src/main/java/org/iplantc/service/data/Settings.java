...
public class Settings 
{
	...
	public static String 						IRODS_PUBLIC_USER;
	public static String 						IRODS_WORLD_USER;
	...
	public static String						IPLANT_TRANSFORMS_SERVICE;
...
//		IRODS_REFRESH_RATE = Integer.valueOf((String)props.get("iplant.irods.refresh.interval"));
		...
		IRODS_PUBLIC_USER = (String)props.get("iplant.irods.public.user");
		
		IRODS_WORLD_USER = (String)props.get("iplant.irods.world.user");
...
//		TACC_MYPROXY_SERVER = (String)props.get("tacc.myproxy.server");
//		
//		TACC_MYPROXY_PORT = Integer.valueOf((String)props.get("tacc.myproxy.port"));
...
//		INDIVIDUAL_DISK_QUOTA = Long.valueOf((String)props.get("iplant.user.disk.quota"));
		...
		IPLANT_TRANSFORMS_SERVICE = (String) props.get("iplant.transform.service");
		if (!IPLANT_TRANSFORMS_SERVICE.endsWith("/")) IPLANT_TRANSFORMS_SERVICE += "/";
