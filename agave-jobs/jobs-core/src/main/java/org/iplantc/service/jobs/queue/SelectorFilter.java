...
public class SelectorFilter {
    ...
    /* ********************************************************************** */
    // Tracing.
    private static final Logger _log = Logger.getLogger(SelectorFilter.class);
    ...
    public static BooleanExpression parse(String filter) throws JobQueueFilterException
    {
        ...
        // time it gets here, but we want to avoid NPEs not matter what. 
        // Empty and blank strings trigger normal exception handling below.
        if (filter == null) {
            String msg = "Null filter error";
            _log.error(msg);
     ...
     throws JobQueueFilterException
    {
        ...
        if (properties != null)
            try {message.setProperties(properties);}
                 ...
                 String msg = "Invalid property assignment.";
                 _log.error(msg, e);
        ...
        try {result = expr.matches(ctx);}
             ...
             String msg = "Filter evaluation failure.";
             _log.error(msg, e);
