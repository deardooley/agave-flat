...
public class QueueConstants
{
    ...
    public static final String TOPIC_QUEUE_PREFIX = "Agave.Job.Topic";
    
    // All phase routing and binding keys.
    public static final String TOPIC_ALL_ROUTING_KEY = TOPIC_QUEUE_PREFIX + ".All";
    public static final String TOPIC_ALL_BINDING_KEY = TOPIC_QUEUE_PREFIX + ".All.#";
    
    // Phase-specific routing keys.
    public static final String TOPIC_STAGING_ROUTING_KEY = TOPIC_QUEUE_PREFIX + "." + JobPhaseType.STAGING.name();
    public static final String TOPIC_SUBMITTING_ROUTING_KEY = TOPIC_QUEUE_PREFIX + "." + JobPhaseType.SUBMITTING.name();
    public static final String TOPIC_MONITORING_ROUTING_KEY = TOPIC_QUEUE_PREFIX + "." + JobPhaseType.MONITORING.name();
    public static final String TOPIC_ARCHIVING_ROUTING_KEY = TOPIC_QUEUE_PREFIX + "." + JobPhaseType.ARCHIVING.name();
